    ...
    public function testClassBehavior()
    {
        $this->specify(
            ...
            function() {
                $tschema = $this->getMockBuilder(TableSchema::class)
                                ->getMock();
                $tschema->expects($this->exactly(4))
                        ->method('getColumn')
                        ->willReturnOnConsecutiveCalls(
                            new ColumnSchema([
                                'name' => 'col',
                                'dbType' => 'varchar',
                                'type' => Schema::TYPE_BIGPK,
                            ]),
                            new ColumnSchema([
                                'name' => 'col',
                                'dbType' => 'varchar',
        ...
        $this->specify(
            ...
            function() {
                ...
                $tschema->expects($this->exactly(6))
                        ->method('getColumn')
                        ->willReturnOnConsecutiveCalls(
                            new ColumnSchema([
                                'name' => 'col',
        ...
        $this->specify(
            ...
            function() {
                $schema = Yii::$app->getDb()->getSchema();
                $tschema = $this->getMockBuilder(TableSchema::class)->getMock();
                $tschema->expects($this->exactly(5))
                        ->method('getColumn')
                        ->willReturnOnConsecutiveCalls(
                            new ColumnSchema([
                                'name' => 'col',
        ...
        $this->specify(
            ...
            function() {
                $schema = Yii::$app->getDb()->getSchema();
                $tschema = $this->getMockBuilder(TableSchema::class)->getMock();
                $tschema->expects($this->exactly(1))
                        ->method('getColumn')
                        ->willReturnOnConsecutiveCalls(
                            new ColumnSchema([
                                'name' => 'col',
        ...
        $this->specify(
            ...
            function() {
                $schema = Yii::$app->getDb()->getSchema();
                $tschema = $this->getMockBuilder(TableSchema::class)->getMock();
                $tschema->expects($this->exactly(3))
                        ->method('getColumn')
                        ->willReturnOnConsecutiveCalls(
                            new ColumnSchema([
                                'name' => 'col',
        ...
        $this->specify(
            ...
            function() {
                ...
                $cbuilder = $this->getMockBuilder(ColumnSchemaBuilder::class)
    ...
    public function testResolveString()
    {
        $test = [
            ...
            [
                ...
                'expect' => 'Schema::TYPE_STRING' . '." NULL DEFAULT NULL COMMENT \'Some comment\'"',
            ],
    ...
    public function testResolveNumeric()
    {
        $test = [
            [
                ...
                'expect' => 'Schema::TYPE_BOOLEAN' . '." NULL DEFAULT TRUE"',
            ],
            [
                'col' => new ColumnSchema(
                    [
    ...
    public function testResolveEnumType()
    {
        $test = [
            ...
            [
                ...
                'expect' => '"enum(\'one\', \'two\', \'three\') NOT NULL DEFAULT \'two\'"',
            ],
        ];
