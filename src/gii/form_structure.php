...
echo $form->field($generator, 'genmode')->dropDownList([
    ...
    'bulk' => 'All in one file',
]);
echo $form->field($generator, 'prefix');
$relOpts = Html::tag('div', $form->field($generator, 'fkOnUpdate'));
$relOpts .= Html::tag('div', $form->field($generator, 'fkOnDelete'));
echo Html::tag('div',
    $relOpts,
    ['style' => 'display:grid; grid-gap:30px; grid-template-columns: 1fr 1fr;']);
